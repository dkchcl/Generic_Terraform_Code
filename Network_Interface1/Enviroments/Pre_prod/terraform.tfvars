...
nic_name = {
  nic1 = {
    ...
    ip_configuration = [
      {
        name = "preprod-ip-config1"
        # subnet_id                                          = "/subscriptions/b398fea1-2f06-4948-924a-121d4ed265b0/resourceGroups/preprod_rg_01/providers/Microsoft.Network/virtualNetworks/preprod-vnet-01/subnets/subnet-02"
    ...
    tags = {
      "Environment" = "preprodelopment"
      "Owner"       = "preprodOps Team"
    }
  }
  ...
  nic2 = {
    ...
    ip_configuration = [
      {
        name = "preprod-ip-config3"
        # subnet_id                     = "/subscriptions/b398fea1-2f06-4948-924a-121d4ed265b0/resourceGroups/preprod_rg_02/providers/Microsoft.Network/virtualNetworks/preprod-vnet-02/subnets/subnet-A"
        private_ip_address_allocation = "Dynamic"
        # private_ip_address_version                         = "IPv4"
        # public_ip_address_id                               = null
        # gateway_load_balancer_frontend_ip_configuration_id = null
